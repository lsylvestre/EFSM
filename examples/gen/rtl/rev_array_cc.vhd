-- AVALON MM-slave wrapper around the core rev_array IP
library IEEE;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;
use work.misc_rev_array.all;

entity avs_rev_array is
  port (avs_s0_address : in std_logic_vector(3 downto 0)  := (others => '0');
          ...
          -- 0011  : wildcard_0284 register
          -- 0100  : wildcard_0285 register
          -- 0101  : caml_heap_base register
...
architecture rtl of avs_rev_array is
  component rev_array is
  ...
  signal arr: caml_value;
  signal result: unit;
  signal wildcard_0284: unit;
  signal wildcard_0285: unit;
...
begin
  rev_array_CC : component rev_array
    port map (clk => clock_clk,
              ...
              result => result,
              wildcard_0284 => wildcard_0284,
              wildcard_0285 => wildcard_0285);
        ...
        when Idle =>
          if avs_s0_write = '1' then
            case avs_s0_address is
              ...
              when "0001" => arr <= avs_s0_writedata;
              when "0101" => caml_heap_base <= avs_s0_writedata;
              when others => NULL;
            end case;
          end if;
        end case;
    ...
    if rising_edge(clock_clk) then
      if avs_s0_read = '1' then
        case avs_s0_address is
          ...
          when "0001" => avs_s0_readdata <= arr;
          when "0010" => avs_s0_readdata <= X"00000001";
          when "0011" => avs_s0_readdata <= X"00000001";
          when "0100" => avs_s0_readdata <= X"00000001";
          when others => null;
          end case;
        end if;
      end if;
