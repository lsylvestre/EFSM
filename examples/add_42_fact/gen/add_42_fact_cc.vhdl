-- AVALON MM-slave wrapper around the core add_42_fact IP
library IEEE;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;

entity avs_add_42_fact is
...
architecture rtl of avs_add_42_fact is
  component add_42_fact is
...
begin
  add_42_fact_CC : component add_42_fact
        ...
        when Idle =>
          if avs_s0_write = '1' then
            case avs_s0_address is
              ...
              when "0001" => a <= to_integer(unsigned(avs_s0_writedata));
              when others => NULL;
            end case;
          end if;
        end case;
    ...
    if rising_edge(clock_clk) then
      if avs_s0_read = '1' then
        case avs_s0_address is
          ...
          when "0001" => avs_s0_readdata <= std_logic_vector(to_unsigned(a,avs_s0_readdata'length));
          when "0010" => avs_s0_readdata <= std_logic_vector(to_unsigned(result,avs_s0_readdata'length));
          when others => null;
          end case;
        end if;
      end if;
