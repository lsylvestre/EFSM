-- AVALON MM-slave wrapper around the core list_length IP
library IEEE;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;
use work.misc_list_length.all;

entity avs_list_length is
...
architecture rtl of avs_list_length is
  component list_length is
...
begin
  list_length_CC : component list_length
        ...
        when Idle =>
          if avs_s0_write = '1' then
            case avs_s0_address is
              ...
              when "0001" => dataa <= avs_s0_writedata;
    ...
    if rising_edge(clock_clk) then
      if avs_s0_read = '1' then
        case avs_s0_address is
          ...
          when "0001" => avs_s0_readdata <= dataa;
