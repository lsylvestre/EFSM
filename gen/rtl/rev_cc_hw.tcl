...
set_module_property NAME rev_ccset_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP my_ips
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME rev_cc
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL rev_cc
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file rev_cc.vhd VHDL PATH ../rtl/rev_cc.vhd
add_fileset_file rev.vhd VHDL PATH ../rtl/rev.vhd
add_fileset_file rev_misc.vhd VHDL PATH ../rtl/misc/rev_misc.vhd
...
add_interface_port rm avm_wm_write readdata Input 32
add_interface_port wm avm_wm_writedata writedata Output 32@add_interface_port wm avm_wm_waitrequest waitrequest Input 1
...
set_interface_property reset clockRate 0
