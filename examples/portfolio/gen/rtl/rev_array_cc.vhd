...
entity avs_rev_array is
  port (avs_s0_address : in std_logic_vector(3 downto 0)  := (others => '0');
          ...
          -- 0011  : wildcard_0001 register
          -- 0100  : wildcard_0002 register
...
architecture rtl of avs_rev_array is
  ...
  signal a: caml_value;
  signal result: unit;
  signal wildcard_0001: unit;
  signal wildcard_0002: unit;
...
begin
  rev_array_CC : component rev_array
    port map (clk => clock_clk,
              ...
              result => result,
              wildcard_0001 => wildcard_0001,
              wildcard_0002 => wildcard_0002);
