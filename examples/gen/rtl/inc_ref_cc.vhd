-- AVALON MM-slave wrapper around the core inc_ref IP
library IEEE;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;
use work.misc_inc_ref.all;

entity avs_inc_ref is
...
architecture rtl of avs_inc_ref is
  component inc_ref is
