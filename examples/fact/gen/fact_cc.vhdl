        ...
        when Idle =>
          if avs_s0_write = '1' then
            case avs_s0_address is
              ...
              when "0001" => dataa <= to_integer(unsigned(avs_s0_writedata));
              when others => NULL;
            end case;
          end if;
        end case;
    ...
    if rising_edge(clock_clk) then
      if avs_s0_read = '1' then
        case avs_s0_address is
          ...
          when "0001" => avs_s0_readdata <= std_logic_vector(to_unsigned(dataa,avs_s0_readdata'length));
